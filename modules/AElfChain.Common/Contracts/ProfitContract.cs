...
namespace AElfChain.Common.Contracts
{
    public enum ProfitMethod
    {
        ...
        IncreaseBackupSubsidyTotalShare,
        SetMaximumProfitReceivingPeriodCount,
        //view
...
//MinerReward: MinerBasicReward,VotesWeightReward,ReElectionReward
    ...
    public class ProfitContract : BaseContract<ProfitMethod>
    {
        ...
        public GetProfitAmountOutput GetProfitAmount(string account, Hash? schemeId)
        {
            var newTester = GetNewTester(account);
            return newTester.CallViewMethod<GetProfitAmountOutput>(ProfitMethod.GetProfitAmount, new GetProfitAmountInput
            {
                SchemeId = schemeId,
        ...
        public int GetMaximumProfitReceivingPeriodCount()
        {
            return CallViewMethod<Int32Value>(ProfitMethod.GetMaximumProfitReceivingPeriodCount, new Empty()).Value;
        }
    }
}